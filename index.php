...
<?php
    ...
    switch ($pilih) {
        ...
        case "1.3":
            ...
            break;
        case "1.4":
            $tampil = "anggota/mst_profil_anggota.php";
            break;
        case "2.1":
                ...
                <div id="sidebar" class="nav-collapse ">
                    ...
                    ?>
                        <ul class="sidebar-menu" id="nav-accordion">
                            ...
                            <li class="sub-menu">
                                <a href=index.php?pilih=1.4><i class="fa fa-bitcoin"></i><span style="font-size:120%; color:#fff;"> Menu Profile</span></a>
                            </li>
                            <li class="sub-menu">
                                <a href="index.php?pilih=4.5">
                                    <i class="fa fa-key"></i>
                    ...
                    <hr>
                    <center>
                        <p id="footer-text">Copyright &copy; <?php echo date('Y'); ?></br><font color="red" alt="koperasi energika">Koperasi Energika | by <font color="red" alt="amirsantoso"><a href="https://amirsantoso.netlify.app/" target="_blank" rel="noopener noreferrer">Sentot</a></font>
                        </p>
                    </center>
                    <!-- sidebar menu end-->
                </div>
