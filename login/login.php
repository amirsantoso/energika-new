...
<body>
  ...
  <footer class="container">
    <p id="footer-text">Copyright &copy; <?php echo date('Y'); ?> <font color="red" alt="koperasi energika">Koperasi Energika | by <font color="red" alt="amirsantoso"><a href="https://amirsantoso.netlify.app/" target="_blank" rel="noopener noreferrer">Sentot</a></font>
    </p>
  </footer>
